...
public class AdminServiceImpl  implements AdminService{
	...
	public Admin updateAdmin(Admin admin,long id) {
		...
		ad.setReservationRecord(admin.getReservationRecord());
	...
	@Override
	public List<Admin> getAdminByReservationRecord(String reservationRecord) {
		return adminRepository.findAdminByReservationRecord(reservationRecord);
	}
