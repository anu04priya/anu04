...
public class AdminController {
	...
	@GetMapping("/adminByReservationRecord/{reservationRecord}")
	public List<Admin>getAdminByReservationRecord(@PathVariable("reservationRecord")String reservationRecord){
		return adminService.getAdminByReservationRecord(reservationRecord);
	}
	@DeleteMapping
